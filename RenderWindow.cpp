...
RenderWindow::RenderWindow
    ...
    loopsizeSlider              = new QSlider                   (Qt::Horizontal,        this);
    ...
    loopsizeLabel               = new QLabel                    ("loopsize",             this);
    ...
    windowLayout->addWidget(loopsizeSlider,			    nStacked+2,	1,			1,			1			);
    windowLayout->addWidget(loopsizeLabel,			    nStacked+2,	3,			1,			1			);
...
void RenderWindow::ResetInterface()
    ...
    loopsizeSlider		    ->setMinimum		(0);
    loopsizeSlider		    ->setMaximum		(2);
    loopsizeSlider		    ->setValue			(2 * renderParameters->loopsize);
